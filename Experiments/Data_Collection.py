...
def main(config_path=None, hal_config_path=None, args=None):
    ...
    for models in Config["models"]:
        if models not in ["baseline", "slip3d", "noslip3d", 'slip3d_LPF', 'slip3d_150', 'slip3d_LPF_drag']:
            ...
            for scenario in Config["scenarios"]:
                ...
                for trial in range(Config["num_iters"]):
                    ...
                    while ts < time_limit:
                        ...
                        # TODO: if you're doing manual data collection, avoid running the mppi at all. Return directly.
