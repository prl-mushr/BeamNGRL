        ...
        if self.is_using_shared_memory:
            ...
            if self.is_render_colours:
                if 'colour' in raw_readings.keys():
                    ...
                    if self.is_static:
                        images['colour'] = colour_data
                    else:
                        images['colour'] = np.fliplr(np.flipud(colour_data))
                else:
            ...
            if self.is_render_annotations:
                if 'annotation' in raw_readings.keys():
                    ...
                    if self.is_static:
                        images['annotation'] = annotation_data
                    else:
                        images['annotation'] = np.fliplr(np.flipud(annotation_data))
                else:
            ...
            if self.is_render_depth:
                if 'depth' in raw_readings.keys():                    
                    ...
                    if self.is_static:
                        images['depth'] = depth_values
                    else:
                        images['depth'] = np.fliplr(np.flipud(depth_values))
                else:
